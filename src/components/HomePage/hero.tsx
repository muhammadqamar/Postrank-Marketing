  ...
  return (
    <div className="w-full mt-14 md:mt-16 mb-[112px] md:mb-[164px] ">
      <div className=" w-full text-center">
        <h1 className="font-medium text-[42px] leading-[56px] tracking-[-0.96px] md:font-medium md:text-6xl md:!leading-[78px] md:tracking-[-1.2px] mb-3 md:mb-4 text-Black">
          Analyze Your Content{" "}
          <span className="!font-normal italic">Visually</span>
        </h1>
        <TextTag
          as="p"
          color="text-Grey-700"
